/**
 * Import "Westmorland and Furness Way" from a GPX track export
 * (furnessway.co.uk). Source file: westmorland-furness-way-full-route.gpx
 * (7,766 trkpt, single track/segment, point-to-point Alston -> Furness
 * Abbey — straightforward LineString, same shape as
 * scripts/import-roof-of-england.mjs).
 *
 * Run with:  node --env-file=.env.local scripts/import-westmorland-furness-way.mjs
 */
import { readFileSync } from "fs";
import pg from "pg";
const { Pool } = pg;

const GPX_PATH = "westmorland-furness-way-full-route.gpx";
const TRAIL_NAME = "Westmorland and Furness Way";
const TRAIL_SLUG = "westmorland-and-furness-way";
...
// Chosen to match "Lakeland Way"/"Lakeland Way Ultra" (near-identical
// Cumbria/Lake District territory), not the vaguer "England" used for
// "Cumbria Way"/"Cumbria Coastal Way".
const TRAIL_REGION = "North West England";
