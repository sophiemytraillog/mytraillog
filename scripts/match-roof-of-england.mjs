/**
 * Run trail matching for every user against the newly-imported "Roof of
 * England Walk" (id e5057aa8-4b6c-414c-9cce-1d5bd5ff2b94). Duplicates
 ...
 *
 * Run with:  node --env-file=.env.local scripts/match-roof-of-england.mjs
 */
import pg from "pg";
const { Pool } = pg;
...
const TRAIL_ID = "e5057aa8-4b6c-414c-9cce-1d5bd5ff2b94";
...
console.log(`Matching ${users.length} user(s) against Roof of England Walk (${TRAIL_ID})...\n`);
